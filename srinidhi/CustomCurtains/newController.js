...
curtains.controller('curtainsController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
        ...
        $rootScope.setSelectedCurtain = function (name, searchBySkuIdFlag) {
            ...
            if (!$rootScope.selectedCurtain) {
                $scope.$watch(function () {
                    ...
                    if (newValue !== oldValue) {
                        console.log('setselectedcurtain1');
                        ...
                        $scope.$watch(function () {
                            ...
                            if (newValue !== oldValue) {
                                console.log('setselectedcurtain2');
                                $rootScope.getCost();
                            }
                        });
                    }
...
curtains.controller('fabricController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
        ...
        if ($state.current.name == 'fabric') {
            ...
            function emptyFilterList() {
                $scope.filterOptionIdList = [];
                $scope.filterOptionNameList = {};
            }

            emptyFilterList();

            $rootScope.selectedNavItem = 'fabric';
            $scope.showMobileFilterDiv = 'colors';
            ...
            function getCurtains() {
                ...
                $rootScope.searchByIdDict.searchById = null;
            ...
            function getAllCurtainsOfSelectedType() {
                $http({
                    ...
                    if ($rootScope.selectedCurtainFlag && !$rootScope.selectedCurtain) {
            ...
            function fetchData() {
                ...
                if ($scope.nextPage != null) {
                    $scope.busy = true;
                    if (!$scope.filterOptionIdList.length && !$scope.sortByDict.sortBy && !$scope.searchByIdDict.searchById) {
            ...
            function getFilterListByName(data, filterName, key) {
                for (var i = 0; i < data.length; i++) {
                    if (data[i].name == filterName) {
                        $scope.filterNameIndexMap[key] = data[i].id;
            ...
            function getFilterInputs() {
                $http({
                    ...
                    $scope.filterByColorList = getFilterListByName(response.data, 'colors', 'COLORS');
                    $scope.filterByMaterialList = getFilterListByName(response.data, 'material', 'MATERIALS');
                    $scope.filterByPatternList = getFilterListByName(response.data, 'pattern', 'PATTERN');
                    $scope.sortByInputs = response.data[response.data.length - 1]['sortInput'];
                    $scope.selectedSortByOption = $scope.sortByInputs[0];
                    $scope.sortByDict.sortBy = $scope.selectedSortByOption.value;
                }, function errorCallback(error) {
                    defaultThemeDialog(error.data);
                })
            }
            ...
            function getFilterInputCount() {
                ...
                for (var i = 0; i < filterTypes.length; i++) {
                    ...
                    for (var j = 0; j < $scope.selectedFilter[filterTypes[i]].length; j++) {
                        selectedFilter[filterTypes[i]].push($scope.selectedFilter[filterTypes[i]][j].name);
                    }
                }
                ...
                $http({
                    ...
                    $scope.changedFilterName != 'COLORS' ? $scope.filterByColorList = response.data[$scope.filterNameIndexMap['COLORS']] : null;
                    $scope.changedFilterName != 'MATERIALS' ? $scope.filterByMaterialList = response.data[$scope.filterNameIndexMap['MATERIALS']] : null;
                    $scope.changedFilterName != 'PATTERN' ? $scope.filterByPatternList = response.data[$scope.filterNameIndexMap['PATTERN']] : null;
                }, function errorCallback(error) {
                    defaultThemeDialog(error.data);
                })
            }
            ...
            function getFilterOptionCurtains() {
                ...
                $http({
                    ...
                    url: '/api/custom-curtains/get-filter-data',
                    params: {
                        'filterOptionsInput': ($scope.filterOptionIdList.join().replace(/,/g, '%2C')),
                        'pageNumber': $scope.nextPage,
                        'sortBy': $scope.sortByDict.sortBy,
                        'searchBySkuId': $scope.searchByIdDict.searchById,
                        'optionId': $scope.optionId,
            ...
            function sortByPrice() {
                for (var i = 0; i < $scope.sortByInputs.length; i++) {
                    if ($scope.sortByInputs[i]['value'] == $scope.sortByDict.sortBy) {
                        $scope.selectedSortByOption = $scope.sortByInputs[i];
                    }
                }
                curtainsLength = 0;
                nextPageFunction();
            ...
            $scope.filterByDropdown = filterByDropdown;
            ...
            function filterByDropdown(filterOption) {
                ...
                angular.forEach($scope.selectedFilter, function (each) {
                    for (var i = 0; i < each.length; i++) {
                        $scope.filterOptionIdList.push(each[i].id);
                    }
                });
            ...
            $scope.mobileSortByPrice = function (value) {
                $scope.sortByDict.sortBy = value;
                sortByPrice();
                $(".jconfirm-closeIcon").click();
            };

            $scope.searchBySkuId = searchBySkuId;
...
curtains.controller('dimensionsController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('liningController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('mountController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('liftController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('hardwareController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('cartController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
...
curtains.controller('deliveredSamplesController', ['$scope', '$http', '$location', '$anchorScroll', '$timeout', '$compile', '$state', '$stateParams', '$rootScope',
    function ($scope, $http, $location, $anchorScroll, $timeout, $compile, $state, $stateParams, $rootScope) {
